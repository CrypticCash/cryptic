...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cryptic " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x0100007f, 0x5ad98aa4, 0x5ad989a4, 0xffc1419f, 0x4375b03e
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cryptic is probably already running."), addrBind.ToString().c_str());
        else
